...
\twocolumn[%
% 中間か最終かを記載する
\noindent{個人報告書（中間）Personal Midterm Report}
% 個々に提出日を記入する
   \hfill{提出日 (Date) 20016/07/27}\par\vskip2zw
\begin{center}
%日本語のプロジェクト名
 {\LARGE 使ってもらって学ぶフィールド指向システムデザイン}\par\vskip1zw
%英語のプロジェクト名
...
%学籍番号、日英の名前
 {\large 1014120\quad 永井陽太\quad Youta Nagai}\par\vskip2zw
\end{center}]%
